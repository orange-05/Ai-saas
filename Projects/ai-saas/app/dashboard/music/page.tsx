...
export default function MusicPage() {
  return (
    <div className="animate-fade-in" style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center', paddingTop: 60 }}>
      ...
      <h1 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: 12 }}>Music Generation</h1>
      <p style={{ color: '#6b7280', marginBottom: 32, lineHeight: 1.7 }}>
        Create original music compositions, beats, and soundscapes with AI.<br/>
      ...
      <div style={{
        ...
        <p style={{ color: '#9ca3af', fontSize: '0.875rem', marginBottom: 20 }}>Get access to Music & Video generation plus unlimited usage of all AI tools.</p>
